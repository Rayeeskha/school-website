...
class Carousel {
  ...
  setupCarousel() {
    ...
    controls.className = 'home-carousel-controls';
    ...
    this.carouselOptions.forEach((option) => {
      ...
      btn.className = `home-carousel-control home-carousel-control-${option}`;
  ...
  play() {
    const playBtn = document.querySelector('.home-carousel-control-play');
