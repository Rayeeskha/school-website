...
class MediaRepository extends BaseRepository
{
    ...
    public function index(){
        $data = Media::select('*',\DB::raw('@rownum  := @rownum  + 1 AS DT_RowIndex'))->orderBy('id', 'DESC');
        return Datatables::of($data)->addIndexColumn()
            ->addColumn('action', function($row){
                $btn = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" class="edit btn btn-info btn-md editMedia"><span class=" bx bx-edit text-white"></span></a>'; 
