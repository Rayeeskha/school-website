...
@section('page_title',Lang::get('front.ghareeb_nawaz') . " ".Lang::get('front.staff_details'))
@section('meta_keywords',Lang::get('front.ghareeb_nawaz'). " ". Lang::get('front.staff_details'))
@section('meta_description', Lang::get('front.ghareeb_nawaz'). " ". Lang::get('front.staff_details'))
@section('container')
  ...
  <div class="container-fluid rtl-card">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="teacher-card" style="height:550px; width: 100%">
      <img src="{{ asset($teacher->photo) }}" class="card-img-top" alt="teacher-photo" style="width: 100%; height: 250px; object-position: top;">
          ...
          <div class="card-body " dir="{{ $dir }}" style="height:auto">
            <h5 class="card-title rtl-text">
              <div class="row">
                <div class="col-12">
                  <strong  rtl-text>@lang('front.name'):</strong> <span class="urdu-text"> {{ $name }}</span>
                </div>
                <div class="col-md-12">
